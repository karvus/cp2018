...
I chose to use ``off-the-shelf'' datastructures for this, instead of
writing my own.  For example, two return-values are the least and most
frequently occuring number.  I chose a \texttt{ConcurrentMap<Integer,
  LongAdder>} for this purpose, which I update like so:
...
Mlobortis eget, lacus.  Sed diam.  Praesent fermentum tempor tellus.
